...
This proves that as long as an attractive interaction exists, electrons with opposite spins will form a spin singlet with total spin zero, and two electrons with opposite momenta will pair up, lowering the system’s energy. This is the Cooper pair, which is also the origin of the superconducting state.

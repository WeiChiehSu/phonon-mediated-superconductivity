...
$$
\phi (r_{i} ,R_{a})代表原子核偏離平衡點R_{a}時的電子wavefunction,而\chi (R_{a})代表原子核運動的wavefunction. 將 \phi (r_{i} ,R_{a})\chi (R_{a}) 代入 \widehat{H}\Psi (r_{i} ;R_{a} ) 中，解 Schrödinger equation:
$$

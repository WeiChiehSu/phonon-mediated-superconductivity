...
$$
\begin{cases}
Force-constant-from-ion:C_{k\gamma, k'\gamma'}^{\text{ion}}(r_\gamma - r_{\gamma'}) 
= n_0(r) \frac{\partial V(r)}{\partial R_{k\gamma}(r)}, \\
Force-constant-from-electron:C_{k\gamma, k'\gamma'}^{\text{electron}}(r_\gamma - r_{\gamma'}) 
= \frac{\partial n(r)}{\partial R_{k'\gamma}(r)} \frac{\partial V(r)}{\partial R_{k\gamma}(r)}+n_0(r) \frac{\partial^2 V(r)}{\partial R_{k\gamma}(r) \, \partial R_{k'\gamma}(r)}
\end{cases}
$$

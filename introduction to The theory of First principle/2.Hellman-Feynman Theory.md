...
$$
The{}force{}constant{}of{}the{}system{}is{}defined{}as{}C_{k\gamma,k'\gamma'}(r_{\gamma}-r_{\gamma'}),{}which{}is{}the{}second{}derivative{}of{}the{}total{}energy.{}It{}consists{}of{}two{}contributions:{}the{}ionic{}contribution{}and{}the{}electronic{}contribution:
$$
...
The expression can then be rewritten in the following form:
...
After obtaining the force constants of the system, transforming them into momentum space yields the dynamical matrix:
...
Once the dynamical matrix is obtained, the phonon frequencies of the system can be calculated.
...
$$
Total-Force-constant:C_{k\gamma ,k'\gamma '} (r_{\gamma}-r_{\gamma'})= C_{k\gamma ,k'\gamma '}^{ion}(r_{\gamma}-r_{\gamma'})+C_{k\gamma ,k'\gamma '}^{electron}(r_{\gamma}-r_{\gamma'})
$$

$$
\begin{cases}
Force-constant-form-ion:C_{k\gamma, k'\gamma'}^{\text{ion}}(r_\gamma - r_{\gamma'}) 
= n_0(r) \frac{\partial V_{\text{SCF}}(r)}{\partial R_{k\gamma}(r)}, \\
Force-constant-form-electron:C_{k\gamma, k'\gamma'}^{\text{electron}}(r_\gamma - r_{\gamma'}) 
= \frac{\partial n(r)}{\partial R_{k'\gamma}(r)} \frac{\partial V_{\text{SCF}}}{\partial R_{k\gamma}(r)}+n_0(r) \frac{\partial^2 V_{\text{SCF}}}{\partial R_{k\gamma}(r) \, \partial R_{k'\gamma}(r)}
\end{cases}
$$

$$
C_{k\gamma,k'\gamma'}(r_{\gamma}-r_{\gamma'}) \to \sum_{k',\gamma'}^{} D_{k,\gamma;k',\gamma'}(q)u_{k',\gamma'}(q)=\omega _{q}^{2} u_{k',\gamma'}(q)[phonon-frequency ]
$$

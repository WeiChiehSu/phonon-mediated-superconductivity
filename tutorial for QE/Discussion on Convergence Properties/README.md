...
Here, we list all the degauss electron–phonon coupling constants, electron–phonon weights, and superconducting transition temperatures saved under different parameter settings (e.g., V_61248_data.mat…), as read by plot_compare_tc.m, for comparison:
